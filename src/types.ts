...
export const AGENT_CONFIGS: Record<string, { color: string; emoji: string; title: string }> = {
  ...
  // Personal Orbit Lab roles
  'idea-agent':            { color: '#ffb74d', emoji: '💡', title: 'Inventor' },
  'builder-agent':         { color: '#4fc3f7', emoji: '🛠️', title: 'Builder' },
  'designer-agent':        { color: '#ba68c8', emoji: '🎨', title: 'Designer' },
  'researcher-agent':      { color: '#81c784', emoji: '🔭', title: 'Researcher' },
  'tutor-agent':           { color: '#64b5f6', emoji: '📘', title: 'Tutor' },
  'qa-agent':              { color: '#ff8a65', emoji: '🧪', title: 'Tester' },
  'archivist-agent':       { color: '#a1887f', emoji: '🗂️', title: 'Archivist' },
  'launcher-agent':        { color: '#4db6ac', emoji: '🚀', title: 'Launcher' },
  'station-ops-captain':   { color: '#d8d8d8', emoji: '🛰️', title: 'Portfolio Coach' },
  'station-systems-engineer': { color: '#cfcfcf', emoji: '🛠️', title: 'GitHub Polish Agent' },
  'station-coordinator':   { color: '#f2f2f2', emoji: '🧭', title: 'Project Finder' },
  'station-mission-specialist': { color: '#b7e5ff', emoji: '📘', title: 'Skill Mentor' },
  'station-field-tech':    { color: '#8bdcff', emoji: '💼', title: 'Internship Scout' },
  'career-agent':          { color: '#f8b4d9', emoji: '📄', title: 'CV Agent' },
  'portfolio-curator':     { color: '#d8d8d8', emoji: '🛰️', title: 'Portfolio Coach' },
